...
export function CreateOrganizationModal() {
    ...
    const { isPending, mutate } = useMutation({
        mutationFn: async (input: Parameters<typeof authClient.organization.create>[0]) =>
            authClient.organization.create(input),
        onSuccess: (result) => {
            ...
            <DialogContent>
                ...
                >
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Enter the information for a sponsorship organization.
                        </DialogDescription>
                    </DialogHeader>
